         ...
         <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={styles.content}>
            ...
            <TouchableOpacity delayPressIn={0} style={styles.button} onPress={submit}>
              ...
              <Text style={styles.buttonText}>{!loading ? "SIGN IN" : "SIGNING IN"}</Text>
            </TouchableOpacity>
            <Text style={[styles.forgotPasswordText, styles.linkText]} onPress={forgotPassword}>Forgot your password?</Text>
          </View>
